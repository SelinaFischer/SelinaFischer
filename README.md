...
Currently building HostIntel, a digital product focused on operational workflows within hospitality.

The work covers product discovery, workflow analysis, requirements definition, prototyping and user feedback, turning day‑to‑day operational pain points into testable product features.
...
Completed structured training across the product lifecycle, including discovery, customer research, product strategy, prioritisation, MVP definition, delivery, measurement, go‑to‑market and growth.

The programme concluded with a real‑world capstone challenge for Sky, applying the full product process in practice.
